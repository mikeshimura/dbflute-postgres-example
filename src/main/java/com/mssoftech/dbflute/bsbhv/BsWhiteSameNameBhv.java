...
public abstract class BsWhiteSameNameBhv extends AbstractBehaviorWritable<WhiteSameName, WhiteSameNameCB> {
     ...
     */
    public NestedReferrerListGateway<WhiteSameNameRef> loadWhiteSameNameRef(List<WhiteSameName> whiteSameNameList, ReferrerConditionSetupper<WhiteSameNameRefCB> refCBLambda) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WhiteSameNameRef> loadWhiteSameNameRef(WhiteSameName whiteSameName, ReferrerConditionSetupper<WhiteSameNameRefCB> refCBLambda) {
