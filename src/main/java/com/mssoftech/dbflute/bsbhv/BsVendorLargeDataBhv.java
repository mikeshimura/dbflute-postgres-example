...
public abstract class BsVendorLargeDataBhv extends AbstractBehaviorWritable<VendorLargeData, VendorLargeDataCB> {
     ...
     */
    public NestedReferrerListGateway<VendorLargeDataRef> loadVendorLargeDataRef(List<VendorLargeData> vendorLargeDataList, ReferrerConditionSetupper<VendorLargeDataRefCB> refCBLambda) {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<VendorLargeDataRef> loadVendorLargeDataRef(VendorLargeData vendorLargeData, ReferrerConditionSetupper<VendorLargeDataRefCB> refCBLambda) {
