...
func Create_C_SelectMemberDbm() {
	...
	C_SelectMemberDbm.ColumnMemberId = df.CCI(&selectMember, "member_id", memberIdSqlName, "", "", "Integer.class", "memberId", "", false, false,false, "serial", 10, 0, "",false,"","", "","","",false,"sql.NullInt64")
	...
	C_SelectMemberDbm.ColumnBirthdate = df.CCI(&selectMember, "birthdate", birthdateSqlName, "", "", "java.time.LocalDate.class", "birthdate", "", false, false,false, "date", 13, 0, "",false,"","", "","","",false,"df.NullDate")
	...
	C_SelectMemberDbm.ColumnFormalizedDatetime = df.CCI(&selectMember, "formalized_datetime", formalizedDatetimeSqlName, "", "", "java.time.LocalDateTime.class", "formalizedDatetime", "", false, false,false, "timestamp", 26, 3, "",false,"","", "","","",false,"df.NullTimestamp")
